...
$`\eta_{row_{AHP_C}}\hat{row}_{AHP_C}x)+\eta_{col_{AHP_B}}\hat{col}_{AHP_B(x)+\eta_{val_{AHP_C}}\hat{val}_{AHP_C(x)+\eta_{\hat{w}}\hat{w(x)+\eta_{\hat{z}_A}\hat{z}_A(x)+\eta_{\hat{z}_B}\hat{z}_B(x)+\eta_{\hat{z}_C}\hat{z}_C(x)+\eta_{h_0}h_0(x)+\eta_ss(x)\eta_{g_1}g_1(x)+\eta_{h_1}h_1(x)+\eta_{g_2}g_2(x)+\eta_{h_2}h_2(x)+\eta_{g_3}g_3(x)+\eta_{h_3}h_3(x)`$
