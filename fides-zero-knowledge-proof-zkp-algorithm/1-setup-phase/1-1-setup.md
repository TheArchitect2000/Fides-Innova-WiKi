...
$$Setup(1^{\lambda},N)$$:  This function outputs $$pp=PC.Setup(1^{\lambda},d)$$ where $$\lambda$$ is security parameter and the set&#x20;
 ...
 $$d=$$ &lcub; $$d_{AHP}(N,i,j)$$ &rcub;  $_{i=0,1,...,k_AHP, j=1,2,..,s_AHP(i)}^{}$
